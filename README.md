...
| **Criterio** | <div align="center"><b>MinDora</b></div> | <div align="center"><img src="assets/md-images/calm.jpg" alt="Calm" width="80px"/><br>Calm</div> | <div align="center"><img src="assets/md-images/wysa.jpg" alt="Wysa" width="80px"/><br>Wysa</div> | <div align="center"><img src="assets/md-images/equoo.jpg" alt="Equoo" width="80px"/><br>Equoo</div> |
|--------------|-------------------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
...
| **Perfil de Marketing – Estrategias de marketing** | Marketing digital en redes sociales, convenios corporativos y programas de bienestar laboral. | Modelo freemium, marketing con celebridades y alianzas con empresas. | Marketing de contenidos, alianzas B2B y campañas en Instagram y LinkedIn. | Contenido educativo, partnerships B2B y pruebas gratuitas en redes sociales. |
| **Perfil de Producto – Productos & Servicios** | Test biométricos y de autoevaluación, dashboard con tendencias, recomendaciones personalizadas y contacto con psicólogos. | Meditaciones guiadas, historias para dormir, música, ejercicios de respiración, clases de mindfulness. | Chatbot gratuito con CBT/DBT y “pathways” temáticos; sesiones premium con coaches humanos. | Juego con 52 niveles de entrenamiento emocional, versión empresarial y evaluaciones personalizadas. |
| **Perfil de Producto – Precios & Costos** | Modelo freemium con pruebas gratuitas; suscripciones mensuales y convenios corporativos. | **Freemium**; mensual **15 USD**, anual **70 USD**, familiar **100 USD**, de por vida **400 USD**. | **Freemium**; mensual **12 USD**, anual **19 USD**; planes corporativos variables. | **Freemium**; individual **5-10 USD/mes**, corporativos por volumen. |
| **Perfil de Producto – Canales de distribución** | Aplicación móvil (iOS/Android) y web; alianzas con empresas para uso institucional. | App móvil (iOS/Android); web corporativa. | App móvil (iOS/Android); web corporativa. | App móvil (iOS/Android); web; integraciones corporativas. |
| **Análisis SWOT – Fortalezas** | Integración biométrica, enfoque regional en LATAM, personalización y acceso a especialistas. | Disponible 24/7, gran variedad de opciones. | Disponible 24/7, técnicas validadas y chatbot accesible. | Base científica, atractivo visual y gamificación. |
| **Análisis SWOT – Debilidades** | Necesidad de adopción tecnológica en segmentos poco digitalizados. | Precio elevado, sin sesiones en vivo, contenido en inglés principalmente. | No sustituye terapia presencial, limitado a lo que la IA comprende. | Variedad limitada, percepción como app ligera, dependencia del formato lúdico. |
| **Análisis SWOT – Oportunidades** | Creciente interés en salud mental en LATAM, alianzas con empresas y organismos de salud. | Expansión internacional, integración con servicios médicos. | Expansión de mercados, integración con wearables y telemedicina. | Expansión global y en instituciones educativas. |
| **Análisis SWOT – Amenazas** | Competencia internacional con mayor posicionamiento y precios competitivos. | Competencia intensa y apps más baratas. | Regulaciones de datos y fuerte competencia. | Saturación del mercado y cambios en privacidad. |
